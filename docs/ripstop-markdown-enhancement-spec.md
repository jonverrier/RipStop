...
`ripstop-consumer-playbook.md` or contact the platform team.*
```
...
- A leading section pointing at `ripstop-consumer-playbook.md`
...
7. `ripstop-spec.md` §22.4 and §22.2 are updated with the
